    ...
    <main className="mx-auto max-w-[800px] px-5 md:px-8 py-18 md:py-24">
      ...
      <div className="mt-12 pt-8 border-t border-border">
        <p className="text-sm text-steel">
          {isPt
            ? "Dúvidas sobre um item específico? Escreva para contato@dclogisticsbrasil.com.br antes de despachar."
            : "Questions about a specific item? Email contato@dclogisticsbrasil.com.br before dispatching."}
        </p>
      </div>
    </main>
  );
